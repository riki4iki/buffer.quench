...
import { IContext, IThreadState, IParamContext, IParamIdState, SocialType } from "../../../../../types";
import { Repository, getManager } from "typeorm";
import { Page, FacebookPage as fbPage, FacebookUser as fbUserModel } from "../.././../../../models";
...
pageRouter.get("/", async (ctx: IContext<IThreadState>) => {
   ...
   const fbPageRepository: Repository<fbPage> = getManager().getRepository(fbPage);
...
pageRouter.del("/:id", async (ctx: IParamContext<IThreadState, IParamIdState>) => {
